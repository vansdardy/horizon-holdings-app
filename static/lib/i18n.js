...
(function (root, factory) {
  ...
  const STRINGS = {
    en: {
      ...
      'div.desc': 'Dividends the index receives are <b>reinvested into the company that paid them</b>, and the shares they buy are kept here rather than mixed into the main book — so the part of the fund that came from income stays visible. Income is credited on the <b>ex-dividend date</b>, the day the share price drops by roughly the payment: waiting for the cash to actually arrive weeks later would show a fall in NAV followed by an unexplained jump. Whole shares only, as everywhere else; a payment too small to buy one waits for the next. These shares earn dividends themselves, which is what makes it compound, and the <b>annual rebalance absorbs the whole book</b> back into the index.',
      ...
      'div.thPending': 'Awaiting reinvestment',
    ...
    zh: {
      ...
      'div.title': '股息再投资',
      'div.desc': '指数收到的股息会<b>再投资回派息的那家公司</b>,买到的股份单独记在这里,而不是混进主仓位 —— 这样「基金里有多少是靠收益滚出来的」始终看得见。股息按<b>除息日</b>入账,也就是股价大致跌掉派息金额的那一天:如果等到几周后现金真正到账才记,净值会先莫名其妙地跌一下、再莫名其妙地涨回来。同样<b>只买整数股</b>,不够买一股的零头留到下一次。这些股份本身也会再收到股息,复利就是这么来的;而<b>每年的再平衡会把整本账吸收回指数</b>。',
