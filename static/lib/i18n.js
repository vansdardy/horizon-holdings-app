...
(function (root, factory) {
  ...
  const STRINGS = {
    en: {
      ...
      'div.title': 'Reinvested dividends',
      'div.desc': 'Dividends the index receives are <b>reinvested into the company that paid them</b>, and the shares they buy are kept here rather than mixed into the main book — so the part of the fund that came from income stays visible. The money is credited on the <b>ex-dividend date</b>, the day the share price drops by roughly the payment, because that is when the value becomes real; it then buys shares on the <b>pay date</b>, at the price of the session the cash actually arrived. Whole shares only, as everywhere else; a payment too small to buy one waits for the next. These shares earn dividends themselves, which is what makes it compound, and the <b>annual rebalance absorbs the whole book</b> back into the index.',
      'div.payNote': 'Yahoo publishes a pay date for North American listings only — about half this index by weight. For a London, Tokyo or continental European constituent the income is still credited on the ex-date and still counted in NAV, but it <b>stays as cash</b> instead of buying shares on a date that would have to be guessed. That cash is absorbed by the annual rebalance along with everything else.',
      'div.empty': 'No dividends received yet. The first payment from a constituent going ex-dividend will appear here.',
      'div.value': 'Bought with income',
      'div.valueSub': '{v} of NAV',
      'div.received': 'Income received',
      'div.receivedSub': 'across {n} payment(s)',
      'div.positions': 'Companies',
      'div.positionsSub': 'holding income-bought shares',
      'div.thShares': 'Shares from income',
      'div.thAwaiting': 'Awaiting pay date',
      'div.thRemainder': 'Remainder',
      'div.historyTitle': 'Dividend history',
      'div.thExDate': 'Ex-date',
      'div.thPayDate': 'Pay date',
      'div.thPerShare': 'Per share',
      'div.thHeld': 'Shares held',
      'div.thGross': 'Gross',
      'div.thBought': 'Shares bought',
      'div.awaiting': 'Cash awaiting pay date',
      'div.awaitingSub': '{n} payment(s), {k} with no published pay date',
      'div.awaitingNext': 'next paid {d}',
      'div.noPayDate': 'no pay date',
      'div.unpaid': 'not yet paid',
      'div.settledOn': 'bought {d}',
      ...
      'nav.partial': '{n} session(s) still valued with a carried-over close — those points update themselves once the data arrives',
      'nav.days': 'Sessions',
    ...
    zh: {
      ...
      'div.title': '股息再投资',
      'div.desc': '指数收到的股息会<b>再投资回派息的那家公司</b>,买到的股份单独记在这里,而不是混进主仓位 —— 这样「基金里有多少是靠收益滚出来的」始终看得见。现金按<b>除息日</b>入账 —— 股价就是在那一天大致跌掉派息金额,价值从那一刻起就是真实的;而真正<b>买入股份则等到派息日</b>,按现金实际到账那一交易日的价格成交。同样<b>只买整数股</b>,不够买一股的零头留到下一次。这些股份本身也会再收到股息,复利就是这么来的;而<b>每年的再平衡会把整本账吸收回指数</b>。',
      'div.payNote': '雅虎只对北美上市的公司提供派息日 —— 按权重算约占本指数一半。对伦敦、东京和欧洲大陆的成分股,股息依然按除息日入账、依然计入净值,但会<b>以现金形式留着</b>,而不会按一个只能靠猜的日期去买入。这笔现金会在每年再平衡时连同其他一起被吸收。',
      'div.empty': '还没有收到股息。某只成分股除息后,第一笔派息会出现在这里。',
      'div.value': '收益买入的市值',
      'div.valueSub': '占净值 {v}',
      'div.received': '累计收到股息',
      'div.receivedSub': '共 {n} 笔',
      'div.positions': '涉及公司',
      'div.positionsSub': '持有收益买入的股份',
      'div.thShares': '收益买入股数',
      'div.thAwaiting': '待派息现金',
      'div.thRemainder': '零头',
      'div.historyTitle': '派息记录',
      'div.thExDate': '除息日',
      'div.thPayDate': '派息日',
      'div.thPerShare': '每股派息',
      'div.thHeld': '当时持股',
      'div.thGross': '派息总额',
      'div.thBought': '买入股数',
      'div.awaiting': '等待派息的现金',
      'div.awaitingSub': '共 {n} 笔,其中 {k} 笔无公开派息日',
      'div.awaitingNext': '下一笔 {d} 到账',
      'div.noPayDate': '无派息日',
      'div.unpaid': '尚未到账',
      'div.settledOn': '{d} 买入',
      'hold.title': '指数的实际持仓',
      ...
      'nav.maxddSub': '峰值到谷底',
      'nav.partial': '有 {n} 个交易日仍在使用沿用的收盘价 —— 数据到齐后这些点会自动重算',
      'nav.days': '区间天数',
      'nav.simulated': '模拟重算',
      'nav.daysOf': '共 {n} 天记录',
